...
export const addresses: IAddresses = {
  ...
  56: {
    ...
    PID_ADDRESS: "0xce1aD4E2810E413e2e3684DeCC58A0Bd01c907d9", // WHISKEY TOKEN
    SPID_ADDRESS: "0x06cae0720fA3147E2d8dB66A18B7883221D84246", //sWHISKEY TOKEN
    IDO_ADDRESS:'0x3Ae07374d7C89f608906321444e8AFdED91aDA5E', // PID
    ...
    REDEEM_HELPER_ADDRESS: "0xE8eE0bE2d8BAABf9924d7f1459d9467E4399badB", // ?????????NOT USING????????
  ...
  97: {
    ...
    PID_ADDRESS: "0xb76a0730171dA15d685B2EE07588e5e3fa438d01", // WHISKEY TOKEN
    SPID_ADDRESS: "0x91bF19134782860c38Df0089A89b2fb58E5b5b1A", //sWHISKEY TOKEN
    IDO_ADDRESS:'0x75C5C9Fa6bC6d4fBd2099C9aAaBc53e0e68a9C17', // warmup???

    STAKING_ADDRESS: "0x37761855B61117603412A60BF1fFcc278959C62c", // The new staking contract
    STAKING_HELPER_ADDRESS: "0xD4E3C30Fe6C2C34ef483172301132F7E83E9A9dC", // Helper contract used for Staking only
    
    DISTRIBUTOR_ADDRESS: "0xD13c4e8c560B95D11d6E15F9f5061357DDE326B2",
    BONDINGCALC_ADDRESS: "0x855D0eb9CcAFB566dEeBc7089396c5f8af4937C2",
    TREASURY_ADDRESS: "0xcF0C754089B9d9E4f7059264D2872543BFEb024A",
    REDEEM_HELPER_ADDRESS: "0xE8eE0bE2d8BAABf9924d7f1459d9467E4399badB", // ?????????NOT USING????????
  },
};
